...
/**
 * Formular zur Darstellung des zu �ndernden Listitem
 * 
...
//
//	Button newButton = new Button("Neuen Eintrag hinzuf�gen");
...
//
//		Label retailerNameLabel = new Label("H�ndler");
...
//
//	/**
//	 * Clickhandler zum verwerfen der Eingaben und zur R�ckkehr zum Shoppinglist CellTable
//	 * 
//	 */
...
//			//tbd: Ansicht schlie�en und zur�ck zu Shoppinglist CellTable
//		}
//		
//	}
//	
...
//	
//	/**
//	 * Clickhandler zum �ndern der Listitem Eigenschaften. Es erfolgt der Aufruf der
...
//			// Die �nderung wird dem Listitem weitergegeben
...
//			if (result != null) {
//				// Das erfolgreiche Hinzuf�gen eines Eintrags wird an den DOM-Tree propagiert.
...
////
////			if (listitemToDisplay == null) {
////				Window.alert("kein Konto ausgew�hlt!");
////				return;
////			}
...
//
//	/*
//	 * Wenn das anzuzeigende Listitem gesetzt bzw. gel�scht wird, werden die
//	 * zugeh�renden Textfelder mit den Informationen aus dem Listitem Objekt
