...
public class SimpleParagraph extends Paragraph implements IsSerializable {
  ...
  /**
   * Es wird ein No-Argument Konstruktor ben�tigt. Da es einen Konstruktor mit Argumenten
  ...
  /**
   * Konstruktur, der die M�glichkeit bietet bei Instanziierung, einen Wert festzulegen.
   * 
